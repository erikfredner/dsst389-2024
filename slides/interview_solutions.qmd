...
> We split to evaluate how well our final model generalizes to unseen data (i.e., the test data). We stratify the split to ensure that each subset has a similar distribution of the target variable, which helps maintain representative samples.
